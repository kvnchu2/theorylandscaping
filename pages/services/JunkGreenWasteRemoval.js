...
const JunkGreenWasteRemoval = () => {
  return (
  <>
    <section id="int-hero">
      <h1 id="home-h">Junk and Green Waste Removal</h1>
    </section>

    <section id="services" className="sidebyside">
            <div className="left">
                <h2 className="title">Junk and Green Waste Removal</h2>
                 <p>
            ...
            <picture className="right">
                ...
                <div className="services-image">
                  <Image loading="lazy" decoding="async" src={Junk} alt="house" width="611" height="861"></Image>
                </div>
             </picture>
    </section>
...
export default JunkGreenWasteRemoval;